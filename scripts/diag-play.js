...
const PORT = Number(process.env.VPC_CDP_PORT || 9347);
...
(async () => {
    ...
    const c = spawn(ELECTRON, [ROOT, '--remote-debugging-port=' + PORT, '--user-data-dir=' + tmp, '--no-first-run'], { stdio: ['ignore', 'pipe', 'pipe'], env: { ...process.env, VPC_CACHE_DIR: tc } });
