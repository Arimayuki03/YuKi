...
2. [用户使用指南](GUIDE.md)：安装、首次启动配置与 FAQ（最终用户从这里开始）。
3. [当前开发状态](../PROGRESS.md)：当前完成范围、边界、约束和下一步。
4. [系统架构](ARCHITECTURE.md)：进程模型、双引擎、播放、下载和数据流。
5. 根据具体任务进入专项文档或执行计划。
...
| 文档 | 用途 | 维护方式 |
|---|---|---|
| [GUIDE.md](GUIDE.md) | 用户使用指南：安装、首次配置、功能讲解与 FAQ（面向最终用户） | 用户可感行为变化时更新 |
